...
export const uiStrings: Record<Locale, Record<string, string>> = {
  en: {
    ...
    world: 'World', locations: 'Locations', activities: 'Activities', collection: 'Collection', items: 'Items', map: 'Map', farm: 'Farm', spellcasting: 'Spellcasting',
  ...
  es: {
    ...
    world: 'Mundo', locations: 'Ubicaciones', activities: 'Actividades', collection: 'Colección', items: 'Objetos', map: 'Mapa', farm: 'Granja', spellcasting: 'Hechizos',
  ...
  ja: {
    ...
    world: '世界', locations: 'ロケーション', activities: 'アクティビティ', collection: 'コレクション', items: 'アイテム', map: 'マップ', farm: '農場', spellcasting: '呪文詠唱',
  ...
  zh: {
    ...
    world: '世界', locations: '地点', activities: '活动', collection: '收藏', items: '物品', map: '地图', farm: '农场', spellcasting: '法术',
  ...
  'zh-hant': {
    ...
    world: '世界', locations: '地點', activities: '活動', collection: '收藏', items: '物品', map: '地圖', farm: '農場', spellcasting: '法術',
  ...
  de: {
    ...
    world: 'Welt', locations: 'Orte', activities: 'Aktivitäten', collection: 'Sammlung', items: 'Gegenstände', map: 'Karte', farm: 'Bauernhof', spellcasting: 'Zaubersprüche',
  ...
  fr: {
    ...
    world: 'Monde', locations: 'Lieux', activities: 'Activités', collection: 'Collection', items: 'Objets', map: 'Carte', farm: 'Ferme', spellcasting: 'Sorts',
  ...
  ko: {
    ...
    world: '세계관', locations: '장소', activities: '활동', collection: '컬렉션', items: '아이템', map: '지도', farm: '농장', spellcasting: '주문 시전',
