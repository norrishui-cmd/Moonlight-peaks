...
export const uiStrings: Record<Locale, Record<string, string>> = {
  en: {
    ...
    world: 'World', locations: 'Locations', activities: 'Activities', items: 'Items', map: 'Map',
  ...
  es: {
    ...
    world: 'Mundo', locations: 'Ubicaciones', activities: 'Actividades', items: 'Objetos', map: 'Mapa',
  ...
  ja: {
    ...
    world: '世界', locations: 'ロケーション', activities: 'アクティビティ', items: 'アイテム', map: 'マップ',
  ...
  zh: {
    ...
    world: '世界', locations: '地点', activities: '活动', items: '物品', map: '地图',
  ...
  'zh-hant': {
    ...
    world: '世界', locations: '地點', activities: '活動', items: '物品', map: '地圖',
  ...
  de: {
    ...
    world: 'Welt', locations: 'Orte', activities: 'Aktivitäten', items: 'Gegenstände', map: 'Karte',
