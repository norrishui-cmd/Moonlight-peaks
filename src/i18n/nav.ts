...
export const uiStrings: Record<Locale, Record<string, string>> = {
  en: {
    ...
    world: 'World', locations: 'Locations', activities: 'Activities', items: 'Items', map: 'Map', farm: 'Farm',
  ...
  es: {
    ...
    world: 'Mundo', locations: 'Ubicaciones', activities: 'Actividades', items: 'Objetos', map: 'Mapa', farm: 'Granja',
  ...
  ja: {
    ...
    world: '世界', locations: 'ロケーション', activities: 'アクティビティ', items: 'アイテム', map: 'マップ', farm: '農場',
  ...
  zh: {
    ...
    world: '世界', locations: '地点', activities: '活动', items: '物品', map: '地图', farm: '农场',
  ...
  'zh-hant': {
    ...
    world: '世界', locations: '地點', activities: '活動', items: '物品', map: '地圖', farm: '農場',
  ...
  de: {
    ...
    world: 'Welt', locations: 'Orte', activities: 'Aktivitäten', items: 'Gegenstände', map: 'Karte', farm: 'Bauernhof',
