...
export const charTranslations: Record<'es' | 'ja' | 'zh' | 'zh-hant' | 'de' | 'fr' | 'ko', Record<string, CharTranslation>> = {
  de: {
    ...
    kai: {
      ...
      desc: 'Porträt gezeigt; noch nicht als Moonlight-Peaks-Charakter bestätigt. Name, Familie und Details werden zum Launch verifiziert.',
      knownInfo: [],
      romanceYes: '', romanceNo: '', romanceTbc: 'Noch nicht bestätigt, ob Kai eine Romanze-Option ist.',
    },
    celine: {
      name: 'Celine', familyLabel: 'Unbekannt', typeLabel: 'Sonstige',
      desc: 'Porträt gezeigt; noch nicht als Moonlight-Peaks-Charakter bestätigt. Name, Familie und Details werden zum Launch verifiziert.',
      knownInfo: [],
      romanceYes: '', romanceNo: '', romanceTbc: 'Noch nicht bestätigt, ob Celine eine Romanze-Option ist.',
    },
  },
  es: {
    'count-dracula': {
    ...
    kai: {
      name: 'Kai', familyLabel: 'Desconocida', typeLabel: 'Otro',
      desc: 'Retrato mostrado; aún no confirmado como personaje de Moonlight Peaks. El nombre, la familia y los detalles se verificarán al lanzamiento.',
      knownInfo: [],
      romanceYes: '', romanceNo: '', romanceTbc: 'Aún no confirmado si Kai es una opción romántica.',
    },
    celine: {
      name: 'Celine', familyLabel: 'Desconocida', typeLabel: 'Otro',
      desc: 'Retrato mostrado; aún no confirmado como personaje de Moonlight Peaks. El nombre, la familia y los detalles se verificarán al lanzamiento.',
      knownInfo: [],
      romanceYes: '', romanceNo: '', romanceTbc: 'Aún no confirmado si Celine es una opción romántica.',
    },
  },
  fr: {
    saga: {
  ...
  ja: {
    ...
    evan: {
      name: 'エヴァン', familyLabel: '吸血鬼一族(アンブロシア)', typeLabel: '吸血鬼',
      desc: '物静かでよそよそしい吸血鬼。妹のミナと一緒に「Coffee & Coffins」を営んでいる。父Orlockから家名を継ぐようプレッシャーをかけられている。',
      knownInfo: [
        '確認済み:Orlockの息子でミナの兄弟。町のカフェを共同経営している。',
        '父が継がせたがっている家名を継ぐより、星を数える方を好む。',
        '確認された贈り物:黒いチューリップとカプチーノを溺愛。紫のチューリップと紫のアザレアを好む。',
      ],
      romanceYes: 'エヴァンは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    logan: {
      name: 'ローガン', familyLabel: '人狼一族', typeLabel: '人狼',
      desc: '訂正:発売後の複数の情報源により、「ローガン」は個々の住民の名前ではなく人狼一族の姓であることが確認された——以前の「人狼の町長ローガン」という報告はBrookを指していた。実際の町長でローガン家の家長についてはBrookのプロフィールを参照。',
      knownInfo: [
        '訂正:この項目はもともと発売前の名称の混同に基づき「ローガン」を独立したキャラクターとして扱っていた。発売後、複数の情報源によりローガンは人狼一族の姓であることが確認された——その家長は町長のBrookで、弟はRidge、子供はSagaとLudo。',
        'このサイトの他のページがまだこのURLにリンクしているため、削除せずリダイレクトページとして残している——実際のローガン家の住民についてはBrook、Ridge、Saga、Ludoを参照。',
      ],
      romanceYes: '', romanceNo: 'ローガンは恋愛対象ではありません(一族の姓であり個人ではないため)。', romanceTbc: '',
    },
    'pumpkin-head': {
      name: 'パンプキンヘッド', familyLabel: '不明', typeLabel: 'その他',
      desc: '町の集まりを盛り上げる、報告されている演劇イベントの司会者。',
      knownInfo: [
        '町の集まりに現れる演劇イベントの司会者として報告されている。',
        '役割と詳細は発売時に確認予定。',
      ],
      romanceYes: '', romanceNo: '報告によれば恋愛対象ではありません。', romanceTbc: '',
    },
    kai: {
      name: 'カイ', familyLabel: '不明', typeLabel: 'その他',
      desc: '肖像は公開されているが、ムーンライト・ピークスのキャラクターとしてはまだ確認されていない。名前、家族、詳細は発売時に検証される。',
      knownInfo: [],
      romanceYes: '', romanceNo: '', romanceTbc: 'カイが恋愛対象かどうかはまだ確認されていません。',
    },
    celine: {
      name: 'セリーヌ', familyLabel: '不明', typeLabel: 'その他',
      desc: '肖像は公開されているが、ムーンライト・ピークスのキャラクターとしてはまだ確認されていない。名前、家族、詳細は発売時に検証される。',
      knownInfo: [],
      romanceYes: '', romanceNo: '', romanceTbc: 'セリーヌが恋愛対象かどうかはまだ確認されていません。',
    },
    ridge: {
      name: 'リッジ', familyLabel: '人狼一族(ローガン)', typeLabel: '人狼',
      desc: '町の大工で、無骨で頼りになる平和主義者。人狼としての夜の時間を使って良質な木材を探している。家族を深く大切にしている。Brook町長の弟。',
      knownInfo: [
        '人狼の大工で平和主義者として確認済み。',
        '人狼の時間帯に木材を探しており、家族と親密。',
        '確認済み:プレイヤーに最初の納屋を販売(4,000ゴールド+資材、10x6のスペース、建設に1晩、動物4匹収容可能)。Lunaから家畜を購入する前に必要。',
        '確認済み:道具アップグレード店「Howling Hammer」を経営。月曜〜金曜、午後6時から深夜まで営業。',
        '確認された贈り物:ビールを溺愛。紫のチューリップとBlood Grapeを好む。',
      ],
      romanceYes: 'リッジは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    jada: {
      name: 'ジェイダ', familyLabel: '人間一族(ヘンダーソン)', typeLabel: '人間',
      desc: '超自然的なものに熱狂する、エネルギッシュな遺物収集家。歴史について嬉々として語り尽くす。人狼や吸血鬼と暮らせることに大興奮している。Persephoneの姪、Winstonの妹。',
      knownInfo: [
        'PersephoneとWinstonと共にやってきた、ヘンダーソン人間一族の一員として確認済み。',
        '懐疑的な兄Winstonとは対照的に、遺物収集家で歴史愛好家として報告されている。',
        '確認された代名詞:she/her。',
        'コミュニティ報告:息もつかせぬ怒涛のような話し方が町で少し有名になっており、彼女を落ち着かせられるのは本当に特別な人だけだという。',
        '確認された贈り物:白いバラ、ガスパチョスープ、紫のチューリップを好む。',
      ],
      romanceYes: 'ジェイダは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    jarvis: {
      name: 'ジャービス', familyLabel: '家族なし', typeLabel: '幽霊',
      desc: '町の幽霊の一人で、同じ幽霊のBalthasarと共に報告されている。訂正:発売後の情報源により、七つの家族はDracula、Ambrosia、Logan、Webb、Hosu、Khazan、Hendersonであることが確認されており、Jarvisのような幽霊はDeathと同様にどの家族にも属していない。',
      knownInfo: [
        'Deathと同様、どの家族にも属さない幽霊の住民として確認済み。',
        'データ解析されたファイルには「ジャービスの家」という記載もある。',
      ],
      romanceYes: '', romanceNo: '', romanceTbc: 'ジャービスが恋愛対象かどうかはまだ確認されていません。',
    },
    dragan: {
      name: 'ドラガン', familyLabel: '予言者一族(カザン)', typeLabel: '予言者',
      desc: 'カザン家の予言者兄弟の中で最年長。自身の予言は大抵外れるが、それよりも町で人気のカードゲーム「Nokturna」の作中の考案者として知られている。',
      knownInfo: [
        'AraやAlinaより年上の、カザン予言者一族の最年長として確認済み。',
        '作中でNokturnaの考案者として報告されている(一部報道では「Nocturna」とも表記)。',
        'データ解析されたファイルには「ドラガンの家」という場所も記載されている。',
        '確認された贈り物:月の結晶を溺愛。紫のチューリップ、紫のアザレア、紫のクトニア、Blood Grape、ムーンジュースを好む。',
      ],
      romanceYes: 'ドラガンは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    albertus: {
      name: 'アルベルトゥス', familyLabel: '不明', typeLabel: 'その他',
      desc: '町の掲示板を運営するフクロウ。発売時に「アルベルトゥスの仕事」——プレイヤーが利用可能なクエスト/依頼を確認する掲示板——の出所として確認された。',
      knownInfo: [
        '発売時に確認済み:アルベルトゥスはフクロウであり、「アルベルトゥスの仕事」はクエストを確認できる町の掲示板である。',
        '彼の名前が仕事/依頼システムに結び付けられているという発売前のデータ解析による推測を解決するもの。',
      ],
      romanceYes: '', romanceNo: '', romanceTbc: 'アルベルトゥスが恋愛対象かどうかはまだ確認されていません。',
    },
    alina: {
      name: 'アリーナ', familyLabel: '予言者一族(カザン)', typeLabel: '予言者',
      desc: 'カザン家の中で反抗的な住民——頑固で情熱的、嘘に我慢できない性格。型破りな予言の力を持ち、物陰を好む。',
      knownInfo: [
        'AraとともにDraganの妹として、カザン予言者一族の一員と報告されている。',
        '同じファイルには「アリーナの家」への言及もあり、通りすがりやイベント限定の人物ではなく住民であることを示唆している。',
        'ここに掲載されている肖像は発売前に提供されたロースター画像によるもので、家族、種族、恋愛対象としての状態は実際のゲームに対してまだ検証されておらず、発売後も独自に確認されていない。',
        '確認された贈り物:黒いバラと黒いチューリップを溺愛。紫のチューリップ、紫のアザレア、Blood Grape、ムーンジュースを好む。',
      ],
      romanceYes: 'アリーナは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    death: {
      name: 'デス', familyLabel: '不明', typeLabel: 'その他',
      desc: '文字通りの死神で、休暇で町にくつろぎに来ている——ドライなユーモアの持ち主で、地元の墓地を手入れし、花と魂の両方を集めている。ローブの上にアロハシャツを着ている。',
      knownInfo: [
        '恋愛対象として確認済み——かつての発売前の噂ではなく、正式に確認されている。',
        '確認された性格:ドライなユーモア、墓地の手入れ、花と魂の収集、死神のローブの上にアロハシャツを着ている。',
        'Misty Shoresの墓地エリアにある「デスの小屋」に住んでいる。',
        '確認された解放の流れ:プレイヤーは「A Bridge Too Far」クエストでMisty Shores/アンブロシア墓地を解放した後、彼が虫取り網をくれるまでに2回彼と会う。',
        '公式Wikiで確認済み:プレイヤーと十分な時間を過ごすと、デスは周囲に魂の塊(Soul Blob)が多すぎてくつろげないと打ち明け、それらを集める手伝いを頼んでくる——このやり取りを完了することで、最後の魔法の輪の道具である虫取り網が手に入る。',
        '確認された報酬の節目:彼のためにSoul Blobを10個集めるとアンティーク時計がもらえ、デフォルトの15分から25分に夜の長さを変更できるようになる。合計50個集めると、逆に夜を10分に短縮する2つ目の時計がもらえる。',
        '確認された贈り物:ゴミの瓶とさびた魚の缶詰を溺愛。',
      ],
      romanceYes: 'デスは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    samael: {
      name: 'サマエル', familyLabel: '吸血鬼一族(アンブロシア)', typeLabel: '吸血鬼',
      desc: '何世紀にもわたって町のバー「The Broken Lamp」を経営してきた、謎めいて陰鬱な雰囲気のアンブロシア家の吸血鬼。エルヴィラの兄弟、Orlockの甥。',
      knownInfo: [
        '町のバー「The Broken Lamp」を経営し、アンブロシア家の一員。',
        'エルヴィラの兄弟でOrlockの甥。激しく孤独な外見の下に、真のロマンチストが隠れていると描写されている。',
        '発売週の複数の報道を相互検証して確認:サマエルの関係パネルは(他の独身キャラと違い)最初から友情ハートが4つしかない状態で始まる。これは一部のプレイヤーにはバグのように見えるが実際は違い、彼の恋愛はストーリーの進行に紐づいており、Luna Bayに到達し人魚のHosu家に出会うことで解放される——ペース次第だが、大体初回の秋か冬頃。',
        '確認済み:前提となるクエストは「A Curious Passage」と「The Mysterious Bay」——倒れた木を持ち上げる(Sabrinaから購入したArborascendの呪文を使用、詠唱に3マナ必要)、Ludoと橋を修理する、サマエルの結婚式の準備を手伝う、といった内容を含む。',
        '確認済み:その結婚式はサマエルとキムという人魚のものだが、破談になる——彼女は祭壇で怖気づいて逃げ出してしまう。その後1週間サマエルとはデートできなくなる。その後Orlockが現れ、甥を立ち直らせる手伝いを頼んでくる。これにより彼の恋愛ルートが再び開く。',
        '確認済み:デートのハートレベルの条件——ハグはハートレベル3で解放。デートとキスはハートレベル4で解放。彼の最初のハートイベントは、ハート1に到達した後にThe Broken Lampを訪れることで発生し、そこで彼が泥酔したOrlockをバーから追い出している場面に出くわす。',
        '確認された贈り物:ダイヤモンドとおにぎりを溺愛。紫のチューリップ、紫のアザレア、赤ワイン、白ワインを好む。',
      ],
      romanceYes: 'サマエルは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    elvira: {
      name: 'エルヴィラ', familyLabel: '吸血鬼一族(アンブロシア)', typeLabel: '吸血鬼',
      desc: 'サマエルの姉妹——芸術的で落ち着きのない吸血鬼で、次々と新しい副業に飛びつき、叔父のOrlockをよく困らせている。',
      knownInfo: [
        'サマエルの姉妹でOrlockの姪として確認済み。',
        '繊細で芸術的な一面を隠しており、それを完全に理解しているのはサマエルだけだと言われている。',
        '確認された贈り物:紫のチューリップと紫のアザレアを好む。',
      ],
      romanceYes: 'エルヴィラは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    kim: {
      name: 'キム', familyLabel: '人魚一族(ホス)', typeLabel: '人魚',
      desc: '底なしに元気で明るいホス家の人魚。物語が始まって約1年後に町にやってくる。失われた恋人と再会するクエストが彼女の物語の一部。',
      knownInfo: [
        'ホス人魚一族の一員として確認済み(報道によってはHorseus/Hisuとも表記)、レイとタエの姉妹。',
        '発売週の報道では、明るく尽きることのない好奇心の持ち主と描写されている。',
        '確認済み:ホス家は最初の年の途中で到着し、町に加わる手助けが必要で、Luna Bayで一緒に暮らしている。',
      ],
      romanceYes: 'キムは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    ludo: {
      name: 'ルド', familyLabel: '人狼一族(ローガン)', typeLabel: '人狼',
      desc: 'Brook町長ののんびりした子供(Sagaの兄弟、Ridgeの甥/姪)。家業の大工仕事を学ぶより一晩中眠っている方が好きで、吸血鬼サーフロックのオペラを作曲し、俳句を話すヒキガエルのYabbisと話をしている。',
      knownInfo: [
        'ローガン人狼一族の中で、Brookの子供、Sagaの兄弟、Ridgeの甥/姪として確認済み。',
        'パンケーキと怪談が好きで、犬を飼っている。',
        '確認された贈り物:イチゴを溺愛。紫のチューリップ、Blood Grape、ムーンフルーツを好む。',
      ],
      romanceYes: 'ルドは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    tae: {
      name: 'タエ', familyLabel: '人魚一族(ホス)', typeLabel: '人魚',
      desc: '見事な容姿で地に足の着んだホス家の男性人魚。自分の見た目に誇りを持ち、他人が自信を持てるよう手助けするのが好き。',
      knownInfo: [
        'ホス人魚一族の一員として確認済み、キムとレイの兄弟。(訂正:この項目の以前のバージョンでは単一の情報源に基づき「Tay」という表示名を使用していたが、発売後の複数の情報源が「タエ」であることを確認している。)',
        '義理堅く励まし上手だと描写されている。',
      ],
      romanceYes: 'タエは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    winston: {
      name: 'ウィンストン', familyLabel: '人間一族(ヘンダーソン)', typeLabel: '人間',
      desc: '町の懐疑派——超自然的な町に住むことに気が進まず、すぐにおびえるが、警戒を解けばとても楽しい人物。Persephoneの甥、ジェイダの兄弟。',
      knownInfo: [
        'PersephoneとJadaと共にやってきた、ヘンダーソン人間一族の一員として確認済み。',
        'ムーンライト・ピークスへの引っ越しは彼自身ではなく家族の決断だった——超自然的なものに夢中な妹のジェイダや叔母のPersephoneとは対照的に、町の超自然的な側面を信じておらず、存在しないふりをしたいと思っている。',
        '過剰な想像力が裏目に出ることがあり、放っておくと超自然的な隣人全員を最悪の事態だと疑いがちになる。',
        '確認された代名詞:he/him。',
        '確認された贈り物:ダイヤモンド、黄金の卵、青いアザレア、シャクシュカを溺愛。',
      ],
      romanceYes: 'ウィンストンは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    rei: {
      name: 'レイ', familyLabel: '人魚一族(ホス)', typeLabel: '人魚',
      desc: '物静かで恥ずかしがり屋のホス家の人魚。環境保護に夢中で、日々海岸の清掃に励んでいる。',
      knownInfo: [
        'ホス人魚一族の一員として確認済み、キムとタエの姉妹。(訂正:この項目の以前のバージョンでは単一の情報源に基づき「Ray」という表示名を使用していたが、発売後の複数の情報源が「レイ」であることを確認している。)',
        '海岸清掃と、地元住民に自然を尊重するよう教えることに力を入れている。',
      ],
      romanceYes: 'レイは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    aras: {
      name: 'アラス', familyLabel: '予言者一族(カザン)', typeLabel: '予言者',
      desc: 'カザン予言者一族の地元の仕立て屋で、「Third Eye Threads」を営んでいる。自分の未来を謎のままにしておくため、自身の予言の力を使うのを避けている。',
      knownInfo: [
        'カザン予言者一族の一員として報告されており、仕立て屋「Third Eye Threads」を経営——AlinaとともにDraganの弟。',
        'ファッションと居心地の良い会話を好む。',
        '確認された贈り物:紫のチューリップ、紫のアザレア、赤いアザレア、Blood Grape、ラズベリージャムを好む。',
      ],
      romanceYes: 'アラスは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    persephone: {
      name: 'ペルセポネ', familyLabel: '人間一族(ヘンダーソン)', typeLabel: '人間',
      desc: '自由奔放なヘンダーソン家の家長——姪のジェイダと甥のウィンストンの面倒を見る人間の叔母で、町に新しくやってきた。占星術と水晶が好き。',
      knownInfo: [
        'ヘンダーソン人間一族の家長(ジェイダとウィンストンの叔母)として確認済み。',
        '占星術、チャクラ、オーラ、神秘的な話題に興味を持っている——心機一転を求めて最近町にやってきた。',
        '確認された代名詞:she/her。',
        '命名の経緯:発売前の映像ではこのキャラクターは「Paris Vaughn」という名前で紹介されていたが、発売版では「ペルセポネ」に落ち着いた。',
        '確認された贈り物:手作りの花束を溺愛。ラズベリージャムとマッシュルームシチューを好む。',
      ],
      romanceYes: 'ペルセポネは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    llemi: {
      name: 'レミ', familyLabel: '不明', typeLabel: 'その他',
      desc: '公式Wikiで確認済み:恋愛対象になれる、子供っぽく気まぐれな恋の悪魔で、ドラマと混沌を糧にしている——それこそがムーンライト・ピークスに引き寄せられる理由。Pink Groveのバラ色の牧草地を我が家と呼び、町の心を導く存在と描写されている。',
      knownInfo: [
        '公式Wikiで恋愛対象キャラクターとして確認済み。生まれつき子供っぽく気まぐれで、Pink Groveに住み、ドラマと混沌を糧にしている。',
        '祭りの時にしか町で見かけないとされ、彼の心を射止めるには本当の努力が必要だと描写されている。',
        '確認された贈り物:ダイヤモンド、花束、月の結晶を溺愛。',
      ],
      romanceYes: 'レミは確認済みの恋愛対象です。', romanceNo: '', romanceTbc: '',
    },
    'viktor-dracula': {
      name: 'ヴィクトル', familyLabel: '吸血鬼一族(アンブロシア)', typeLabel: 'その他',
      desc: 'Orlockの老いた叔父で、遠い昔にコウモリに変身し、今はあなたの土地にある地下墓地に住んでいる。恋愛対象ではない。(公式には単に「ヴィクトル」と表記されており、以前使用していた「ヴィクトル・ドラキュラ」という表記は当サイト独自の追加であり、確認された名前ではない。)',
      knownInfo: [
        'Orlockの叔父で、プレイヤーの土地にある地下墓地にいるコウモリの相棒キャラクターとして確認済み。',
        'ドラキュラ伯爵ともヴラドとも異なる存在。',
      ],
      romanceYes: '', romanceNo: 'ヴィクトルは恋愛対象ではありません。', romanceTbc: '',
    },
    judge: {
      name: 'ジャッジ', familyLabel: '不明', typeLabel: 'その他',
      desc: '公式Wikiのナビゲーションで名前の存在が確認されている;役割はまだ出典が確認されていない。',
      knownInfo: ['公式Wikiに掲載されている;これ以上の詳細はまだ出典が確認されていない。'],
      romanceYes: '', romanceNo: '', romanceTbc: 'ジャッジが恋愛対象かどうかはまだ確認されていません。',
    },
    'skull-girl': {
      name: 'スカルガール', familyLabel: '不明', typeLabel: 'その他',
      desc: '独自のスケジュール、贈り物、関係イベントを持つ、しっかりと作り込まれたNPCであることが確認されている——公式Wikiではレミ、パンプキンヘッド、その他家族に属さないキャラクターと一緒に分類されている。性格や背景はまだ出典が確認されていないが、名前だけの掲載をはるかに超えた存在。',
      knownInfo: [
        '公式Wikiのキャラクターナビゲーションで確認済み:レミ、パンプキンヘッド、アルベルトゥス、チェスター、グリム、フーディーニ、ラリー、ミスター・デイズ、レイチェル、ヤビスと共に、家族に属さないキャラクターとして分類されている。',
        '専門のサードパーティ製キャラクターデータベース(誕生日、贈り物への反応リスト、関係イベント、日々のスケジュールがすべて記録されている)で確認済み:彼女は実際にシステムで管理されている住民であり、背景のみのカメオ出演ではない。',
        'まだ出典未確認:彼女の性格、背景、物語における正確な役割——名前から推測するのではなく、信頼できる情報源が彼女について説明し次第、この項目を更新する。',
        '恋愛対象になれるかどうかは現在未検証——公式Wikiが明示的に「恋愛対象」とタグ付けしているレミとは異なり、スカルガールにはまだそのようなタグが見つかっていない。',
      ],
      romanceYes: '', romanceNo: '', romanceTbc: 'スカルガールが恋愛対象かどうかはまだ確認されていません。',
    },
    balthasar: {
      name: 'バルタザール', familyLabel: '家族なし', typeLabel: '幽霊',
      desc: '同じ幽霊のジャービスと共に名前が挙がる、町の幽霊の住民。恋愛対象ではなく、デスと同様、七つの家族のいずれにも属していない。',
      knownInfo: ['町の幽霊キャラクターの一人として確認済み、どの家族にも属していない。(訂正:この項目の以前のバージョンでは七つの家族の一つとして「幽霊一族」を推測していたが、発売後の情報源により七つ目の家族はヘンダーソン家であることが確認されている。)'],
      romanceYes: '', romanceNo: 'バルタザールは恋愛対象ではありません。', romanceTbc: '',
    },
    chester: {
      name: 'チェスター', familyLabel: '不明', typeLabel: 'その他',
      desc: '生きている収納箱で、町役場での登録中にBrook町長から贈られる——一晩の間に商品を入れておくと、目覚めた時に売却金が手に入る。',
      knownInfo: [
        '確認済み:最初の町役場訪問時にBrookから入手する。',
        '一晩の間の販売用収納として機能する。',
      ],
      romanceYes: '', romanceNo: 'チェスターは恋愛対象ではありません(生きた収納箱のため)。', romanceTbc: '',
    },
    laveau: {
      name: 'ラヴォー', familyLabel: '魔女一族(ウェッブ)', typeLabel: '魔女',
      desc: 'あなたのキャラクターの母親——ヴラド・ドラキュラと人生を歩むためにウェッブ一族を去る前は、その魔女団を率いていた魔女。物語の中心人物であり、恋愛対象ではない。',
      knownInfo: [
        'プレイヤーキャラクターの母親であり、元ウェッブ魔女団のリーダー(後継者はフィオナ)として確認済み。',
        '彼女がヴラド・ドラキュラと結婚したことが、あなたのキャラクターが吸血鬼と魔女の混血の血統を持つ理由である。',
      ],
      romanceYes: '', romanceNo: 'ラヴォーは恋愛対象ではありません(物語の中心人物のため)。', romanceTbc: '',
    },
    yabbis: {
      name: 'ヤビス', familyLabel: '不明', typeLabel: 'その他',
      desc: '俳句を話すヒキガエルで、ルドの話し相手を務めている——恋愛対象ではない。',
      knownInfo: ['俳句だけを話すことで知られる、ルドのヒキガエルの相棒として報告されている。'],
      romanceYes: '', romanceNo: 'ヤビスは恋愛対象ではありません(ヒキガエルのため)。', romanceTbc: '',
    },
    grim: {
      name: 'グリム', familyLabel: '不明', typeLabel: 'その他',
      desc: 'ゲーム開始時からあなたに付き従う三つ目のヘルキトゥンの相棒ペットの、おそらくデフォルト/初期の名前(自分で名付けることもできる)——後に自分自身がヘルキトゥンの姿に変身できるようになるのとは別の存在。',
      knownInfo: [
        '確認済み:ヘルキトゥンの相棒はゲーム開始時からプレイヤーに付き従い、名前を付けることができる。',
        '公式Wikiには「グリム」という名前でヘルキトゥンのちびキャラアイコンと共に掲載されている——おそらくこのペットのデフォルト名だが、まだ完全には確認されていない。',
        '後にストーリークエストを通じて解放される、自分自身がヘルキトゥンの姿に変身することとは混同しないこと。',
      ],
      romanceYes: '', romanceNo: 'グリムは恋愛対象ではありません(ペットのため)。', romanceTbc: '',
    },
    'mr-deyes': {
      name: 'ミスター・デイズ', familyLabel: '不明', typeLabel: 'その他',
      desc: '公式Wikiのナビゲーションで名前の存在が確認されている;役割はまだ出典が確認されていない。',
      knownInfo: ['公式Wikiに掲載されている;これ以上の詳細はまだ出典が確認されていない。'],
      romanceYes: '', romanceNo: '', romanceTbc: 'ミスター・デイズが恋愛対象かどうかはまだ確認されていません。',
    },
    hoodini: {
      name: 'フーディーニ', familyLabel: '不明', typeLabel: 'その他',
      desc: '公式Wikiのナビゲーションで名前の存在が確認されており、アルベルトゥスに似た白いフクロウのアイコンで表示されている——関連キャラクターまたはバリエーションの可能性があるが未確認。',
      knownInfo: ['白いフクロウ風のアイコンで公式Wikiに掲載されている;アルベルトゥスとの関連はまだ確認されていない。'],
      romanceYes: '', romanceNo: '', romanceTbc: 'フーディーニが恋愛対象かどうかはまだ確認されていません。',
    },
    larry: {
      name: 'ラリー', familyLabel: '不明', typeLabel: 'その他',
      desc: '公式Wikiで確認済み:ラリーはアリーナの家に住むヴァンプスターで、Cave of Echoesに戻されることを望まず、他の収集対象のヴァンプスターに加わる代わりに彼女のもとに留まっている。恋愛対象ではない。',
      knownInfo: ['確認済み:アリーナの家で見つかり、他のヴァンプスターのように戻されるのではなく留まることを選んでいる。'],
      romanceYes: '', romanceNo: 'ラリーは恋愛対象ではありません(ヴァンプスターのため)。', romanceTbc: '',
    },
    rachel: {
      name: 'レイチェル', familyLabel: '不明', typeLabel: 'その他',
      desc: '公式Wikiのナビゲーションで名前の存在が確認されており、ヴァンプスターのアイコンで表示されている——町の住民というより個別に名付けられたヴァンプスターである可能性が高い。恋愛対象ではない。',
      knownInfo: ['ヴァンプスターのアイコンで公式Wikiに掲載されている。'],
      romanceYes: '', romanceNo: 'レイチェルは恋愛対象ではありません(ヴァンプスターの可能性が高いため)。', romanceTbc: '',
    },
    snek: {
      name: 'スネック', familyLabel: '不明', typeLabel: 'その他',
      desc: '公式Wikiのナビゲーションで存在が確認されている、名前付きのヘビのキャラクター。恋愛対象ではない。',
      knownInfo: ['ヘビのちびキャラアイコンで公式Wikiに掲載されている。'],
      romanceYes: '', romanceNo: 'スネックは恋愛対象ではありません(ヘビのため)。', romanceTbc: '',
    },
    jacques: {
      name: 'ジャック', familyLabel: '不明', typeLabel: 'その他',
      desc: 'スネックと共に、公式Wikiのナビゲーションで存在が確認されている、名前付きのヘビのキャラクター。恋愛対象ではない。',
      knownInfo: ['ヘビのちびキャラアイコンで公式Wikiに掲載されている。'],
      romanceYes: '', romanceNo: 'ジャックは恋愛対象ではありません(ヘビのため)。', romanceTbc: '',
    },
    'moon-goddess': {
      name: 'ムーンゴッデス', familyLabel: '不明', typeLabel: 'その他',
      desc: '公式Wikiで確認済み:満月の夜に月の岩でできた宮殿から降臨し、その存在でムーンライト・ピークスを祝福する女神——話し方は難解だが、人間たちの間を歩くことを心から楽しんでいる。',
      knownInfo: [
        '公式Wikiで確認済み:満月の時にだけ現れ、宇宙的で難解な話し方にもかかわらず、普通の町の人々の間を歩くのが大好きだと描写されている。',
        'サンゴッドの兄弟(宇宙の双子)であることが確認されている。',
        'コミュニティ報告(日本語圏の報道):Brookと同様、恋愛対象ではなく純粋に友情のみのNPCとして分類されている——ここでのステータスと一致する。',
      ],
      romanceYes: '', romanceNo: 'ムーンゴッデスは恋愛対象ではありません(純粋に友情のみのNPCのため)。', romanceTbc: '',
    },
    'sun-god': {
      name: 'サンゴッド', familyLabel: '不明', typeLabel: 'その他',
      desc: '公式Wikiで確認済み:ムーンゴッデスの宇宙の双子の兄弟で、夏の絶頂期にしか姿を見せない希少な存在——高慢で自尊心が強く、町に友人はほとんどおらず、「夜の住人」たちを遠ざけるオーラをまとっている。',
      knownInfo: [
        '公式Wikiで確認済み:夏の絶頂期にのみ現れ、夜行性の住民を遠ざける高慢で自尊心の強い雰囲気を放っていると描写されている。',
        '町に友人がほとんどいないことが確認されており、本人もそのことを鋭く自覚していると描写されている。',
        'コミュニティ報告(日本語圏の報道):Brookと同様、恋愛対象ではなく純粋に友情のみのNPCとして分類されている——ここでのステータスと一致する。',
      ],
      romanceYes: '', romanceNo: 'サンゴッドは恋愛対象ではありません(純粋に友情のみのNPCのため)。', romanceTbc: '',
    },
    yasmin: {
      name: 'ヤスミン', familyLabel: '不明', typeLabel: 'その他',
      desc: '公式Wikiのナビゲーションで名前の存在が確認されている;役割はまだ出典が確認されていない。',
      knownInfo: ['公式Wikiに掲載されている;これ以上の詳細はまだ出典が確認されていない。'],
      romanceYes: '', romanceNo: '', romanceTbc: 'ヤスミンが恋愛対象かどうかはまだ確認されていません。',
    },
  },
  zh: {
    'count-dracula': {
