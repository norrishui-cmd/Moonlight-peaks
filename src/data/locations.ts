...
export const locationsSection: TopicSection = {
  ...
  schemaType: 'Place',
  title: 'Moonlight Peaks Locations 鈥?Town, Farm, Forest & More',
  description: 'A guide to the places in Moonlight Peaks: the magical mountain town, your farm and cottage, the forest, the lake, the mines and more 鈥?what is confirmed and what we expect at launch.',
  intro: 'The places that make up Moonlight Peaks 鈥?the magical mountain town, your homestead, and the wild spots around it. We mark what is developer-confirmed versus reported, datamined (from pre-launch game files, cross-referenced against pre-launch references), or expected, and fill in detail as the July 7, 2026 launch lands.',
};
...
export const locations: TopicItem[] = [
  {
    ...
    body: [
      ...
      'The town blends cozy village life with the supernatural 鈥?your neighbours are werewolves, witches, mermaids and more, and getting to know them is a big part of the game.',
    ],
  ...
  },
  {
    ...
    body: [
      ...
      'Seasonal celebrations are part of town life 鈥?a theatrical event host has been shown livening up gatherings. The exact layout and which events happen here are confirmed at launch.',
    ],
  ...
  },
  {
    ...
    body: [
      ...
      'You grow enchanted crops and glowing flowers and raise magical livestock like the Draculamb 鈥?all tended by night, since you head back to your coffin by sunrise.',
      'Pre-launch datamined game files (cross-referenced against pre-launch references) refer to this starting farmland internally as "the Plot" 鈥?not developer-confirmed as the in-game name players will see.',
    ],
    related: [{ label: 'Farming guide', href: '/farming' }, { label: 'Your cottage', href: '/locations/your-cottage' }, { label: 'Magic', href: '/magic' }],
    faq: [{ q: 'Do you farm during the day in Moonlight Peaks?', a: 'No 鈥?you farm by night and return to your coffin by sunrise.' }],
  },
  {
    ...
    body: [
      'You live in a gothic cottage that you can make your own. Decorating 鈥?placing and arranging furniture and decor 鈥?is one of the core cozy activities.',
  ...
  },
  {
    ...
    body: [
      'Water areas support fishing, one of the demo\u2019s featured activities. The town\u2019s mermaids 鈥?one of the seven families 鈥?are tied to the water.',
      'Pre-launch datamined game files (cross-referenced against pre-launch references) list a "Silverveil Lake" 鈥?likely this location\u2019s proper in-game name, though not yet developer-confirmed.',
  ...
  },
  {
    ...
    body: [
      ...
      'Whether Moonlight Peaks names a specific pier is confirmed at launch 鈥?for now, treat this as part of the lakeside fishing area.',
    ],
  ...
  },
  {
    ...
    dek: 'Underground areas you can explore 鈥?with no combat.',
    body: [
      ...
      'Pre-launch datamined game files (cross-referenced against pre-launch references) reference several named underground areas 鈥?Cave of Echoes, Crystal Cave, Twilight Catacombs, and Lost Moon Alcove 鈥?suggesting the mines are split into distinct zones rather than one single cave. Not developer-confirmed.',
    ...
    faq: [{ q: 'Is there combat in the mines?', a: 'No 鈥?previews confirm there is no combat anywhere in Moonlight Peaks, including the mines.' }],
  },
  {
    slug: 'graveyard', title: 'The Graveyard', tag: 'Wilds', status: 'datamined', image: '/hero-loc-graveyard.webp',
    dek: 'A quiet, moonlit corner 鈥?pre-launch datamined files name it Ambrosia Graveyard.',
    body: [
      'A graveyard suits the cozy-gothic setting, and the game leans into gentle spooky-season charm rather than horror.',
      'Pre-launch datamined game files (cross-referenced against pre-launch references) name this location "Ambrosia Graveyard," paired with a matching "Ambrosia Mansion" 鈥?likely the vampire family\u2019s ancestral estate. Not developer-confirmed; what you can actually do here is confirmed at launch.',
    ],
  ...
  },
  {
    ...
    body: [
      ...
      'We don\u2019t yet know what each shop sells, who runs it, or its opening hours 鈥?those details, and whether all seven make it into the final game unchanged, are confirmed at launch. Treat this as a name-only reference for now.',
    ],
  ...
  },
  {
    ...
    body: [
      ...
      'We don\u2019t know what happens at each of these yet 鈥?whether they\u2019re explorable areas, backdrops for events, or tied to specific characters and quests. This page exists so the names are documented somewhere honest rather than guessed at; full descriptions are confirmed at launch.',
    ],
