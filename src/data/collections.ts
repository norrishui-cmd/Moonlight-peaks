...
export const collections: CollectionEntry[] = [
  ...
  },
  {
    ...
    quickFacts: [
      { label: 'Total count', value: '53 (confirmed)' },
    ...
    tableRows: [
      ['#1 (unnumbered)', 'Moonlit Pines', "Inside Luna's house, up her spiral stairs by her bed with a candle on its head", 'None known', 'Misty Shores cave', 'Part of the 53-total collection'],
      ['#2 (unnumbered)', 'Misty Shores', 'Inside the Moonlit Tower, hiding behind a tan leafy armchair', '"A Bridge Too Far" (unlocks Misty Shores)', 'Misty Shores cave', 'Part of the 53-total collection'],
