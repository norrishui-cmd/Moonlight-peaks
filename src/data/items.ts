...
export const itemCategories: ItemCategory[] = [
  ...
  },
  {
    ...
    summary: 'Confirmed via Bonus Action and a dedicated post-launch brewing guide: you unlock a cauldron early in the story (repaired via a quest involving your mother and Fiona), and brewing itself is straightforward \u2014 select a recipe you have the ingredients for, interact with the cauldron, and wait, then collect the result once it\u2019s done. Beyond the confirmed Alter Ego Elixir (changes hairstyle, hair color, skin tone, eye color, eyebrows, and makeup, sold by Sabrina), at least 8 more recipes are confirmed by name and exact ingredients, including a Love Potion, Mana Potion, and several utility tonics for fishing, farming, and mining.',
    examples: ['Alter Ego Elixir', 'Love Potion', 'Mana Potion', 'Fierce Forester / Fluent Fishing / Frictionless Farming tonics', 'Rapid Reel Potion', 'Mindless Miner Tonic'],
    verify: ['Exact effect strength and duration for most confirmed recipes', 'Full potion list beyond the 9 currently confirmed by name', 'Brew time per potion'],
  ...
  },
  {
    ...
    group: 'Resources',
    status: 'confirmed',
    dek: 'Ores, gems, and refinable resources gathered underground with no combat, now including a confirmed Crystal Cave and full pickaxe upgrade path.',
    summary: 'Confirmed: mining in Moonlight Peaks has no combat \u2014 you gather ore and crystals from caverns to feed your furnace, tools, and upgrades. Copper and Iron Ore come from the Cave of Echoes in Misty Shores (unlocked via "A Bridge Too Far"), while Rose Quartz and Moon Crystal come from the separate Crystal Cave west of Fiona\u2019s house in Moonlit Pines. The pickaxe upgrade path is confirmed: Rusty \u2192 Copper (3 Copper Bar + 1,000 coins) \u2192 Iron, which is the first tier confirmed to break 60-durability deposits in 8 swings. Ore, Rose Quartz, and Galaxy Crystal deposits reportedly carry a small chance to drop a Diamond plus a separate bonus-reward roll.',
    examples: ['Rose Quartz \u2192 Quartz Dust \u2192 Glass (Crystal Cave)', 'Copper/Iron/Gold Ore (Cave of Echoes)', 'Refined Stone', 'Moon Crystal'],
    verify: ['Moon Crystal\u2019s crafting use', 'Exact Gold Ore location and tool requirement', 'Precise drop-rate percentages for rare bonus rolls'],
...
export const itemFrameworks: Record<string, ItemFramework> = {
  ...
  potions: {
    parameters: [
      { label: 'Data status', value: 'Confirmed via a dedicated post-launch brewing guide, 10+ recipes documented' },
      { label: 'Key fields', value: 'Ingredients and station; effect/duration still being verified per potion' },
      { label: 'Categories', value: 'Utility tonics, farming/fishing/mining boosts, appearance change, romance item' },
    ],
    ...
    rows: [
      ...
      ['Love Potion', '1 Hold-Me-Close, 1 Muse Nut, 1 Amour, 1 Suffrain Powder, 1 Luck Dust', 'Cauldron', 'Not yet confirmed', 'Not yet confirmed', 'Cauldron (repaired via the broken-cauldron quest)'],
      ['Mana Potion', '1 Mana Essence, 1 Drikker, 1 Henbane Powder, 1 Violet, 1 Frosteria', 'Cauldron', 'Restores mana', 'Not yet confirmed', 'Cauldron'],
      ['Fierce Forester Tonic', '1 Sage Powder, 1 Amanita, 1 Light Wood, 1 Cranberry', 'Cauldron', 'Woodcutting boost (reported)', 'Not yet confirmed', 'Cauldron'],
      ['Fluent Fishing Tonic', '1 Splotch, 1 Glow Ginger Powder, 1 Sugar, 1 Volacio', 'Cauldron', 'Fishing boost (reported)', 'Not yet confirmed', 'Cauldron'],
      ['Frictionless Farming Tonic', '1 Onion, 1 Honey, 1 Googly Garlic Powder, 1 Heart Stone', 'Cauldron', 'Farming boost (reported)', 'Not yet confirmed', 'Cauldron'],
      ['Rapid Reel Potion', '1 Angry Mandrake, 1 Wolfsbane Powder, 1 Sugar, 1 Whisper', 'Cauldron', 'Fishing speed boost (reported)', 'Not yet confirmed', 'Cauldron'],
      ['Sunscreen Potion', '1 Fiber, 1 Egg', 'Cauldron', 'Not yet confirmed', 'Not yet confirmed', 'Cauldron'],
      ['Mindless Miner Tonic', '1 Gold Ore, 1 Leftsee, 1 Glowglammer, 1 Nightshade Powder', 'Cauldron', 'Mining boost (reported)', 'Not yet confirmed', 'Cauldron'],
    ],
    sourceNote: 'Ingredients sourced directly from a dedicated post-launch potions and brewing guide. Exact effect strength, duration, and unlock order for most tonics are not yet independently confirmed and are marked accordingly rather than guessed. Quartz Dust and Gold Ore come from mining; Heart Stone and Luck Dust are rare exploration finds; Honey requires built beehives.',
  },
  mineables: {
    parameters: [
      { label: 'Data status', value: 'Confirmed via a dedicated post-launch mining guide' },
      { label: 'Key fields', value: 'Location, tool requirement, processing recipe, notable use' },
      { label: 'Pickaxe upgrade path', value: 'Rusty \u2192 Copper (3 Copper Bar + 1,000 coins) \u2192 Iron (breaks 60-durability deposits in 8 swings) \u2192 higher tiers' },
    ],
    columns: ['Mineable', 'Location', 'Tool requirement', 'Processing', 'Notable use'],
    rows: [
      ['Rose Quartz', 'Crystal Cave (west of Fiona\u2019s house, Moonlit Pines)', 'Iron Pickaxe or better', 'Enchanted Mortar \u2192 Quartz Dust', 'Quartz Dust + Charcoal in a Furnace makes Glass'],
      ['Moon Crystal', 'Crystal Cave (blue-colored deposits, alongside Rose Quartz)', 'Iron Pickaxe or better', 'Not yet confirmed', 'Not yet confirmed'],
      ['Copper Ore', 'Cave of Echoes, Misty Shores', 'Pickaxe (early-game accessible)', 'Furnace: 4 Copper Ore + 1 Charcoal \u2192 3 Copper Bar (36 min)', 'Early tool upgrades, Copper Pickaxe/Axe'],
      ['Iron Ore', 'Cave of Echoes, Misty Shores', 'Copper Pickaxe or better', 'Furnace: 4 Iron Ore + 1 Charcoal \u2192 3 Iron Bar (36 min)', 'Mid-tier tool upgrades'],
      ['Gold Ore', 'Deeper mine levels (per a dedicated potions guide)', 'Iron Pickaxe or better (reported)', 'Furnace: 4 Gold Ore + 1 Charcoal \u2192 6 Gold Bar (36 min)', 'High-tier tool upgrades, Mindless Miner Tonic'],
      ['Stone', 'Common across all mine areas', 'Any Pickaxe', 'Refiner: 6 Stone \u2192 10 Refined Stone (24 min)', 'Refined Stone feeds many crafting recipes'],
      ['Heart Stone', 'Rare find while exploring the mines', 'Not yet confirmed', 'Used directly in potion recipes', 'Frictionless Farming Tonic'],
    ],
    sourceNote: 'Sourced from a dedicated post-launch mining guide and a potions/brewing guide. Ore, Rose Quartz, and Galaxy Crystal deposits are reported to carry a small (about 0.5%) chance to drop a Diamond plus a separate roughly 5% bonus-reward roll; plain Stone deposits only drop their base material. Exact drop rates for Moon Crystal and Gold Ore\u2019s precise tool requirement are not yet independently confirmed here.',
  },
  decorations: {
    parameters: [
