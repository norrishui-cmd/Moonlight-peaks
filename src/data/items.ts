...
export const itemCategories: ItemCategory[] = [
  ...
  },
  {
    ...
    summary: 'Fertilizer pages are useful for players comparing growth speed, crop quality, yield, and profit routes. Moonlight Peaks has enchanted crops and glowing flowers, but exact fertilizer items and effects are not yet independently confirmed here.',
  ...
  },
  {
    ...
    summary: 'Clothing is an important long-tail search topic because players look for outfit lists, shops, unlocks, and cosmetic screenshots. Specific clothing names and shops are not yet independently confirmed here \u2014 we do not invent them.',
  ...
  },
  {
    ...
    summary: 'Fishing is a confirmed activity, and this is one of the most-searched item categories. Exact catch locations, time windows, season rules, and rarity per fish are still being verified rather than guessed at here.',
  ...
  },
  {
    ...
    summary: 'Critter pages are common in life sim wikis because players search for where to find them, whether they are seasonal, and what they are used for. Exact creature behavior in Moonlight Peaks is not yet independently confirmed here.',
  ...
  },
  {
    ...
    summary: 'Cooking pages aim to answer recipe ingredients, energy value, gift value, sell price, and unlock conditions. Exact recipes are still being verified rather than guessed at; this category is kept separate from crafting since food usually serves different player goals.',
  ...
  },
  {
    ...
    summary: 'Crafting is a core wiki category because players search for recipes, ingredients, and unlocks. Exact crafting stations, required materials, and recipe uses are still being verified rather than guessed at here.',
  ...
  },
  {
    ...
    summary: 'Farm Helpers is a useful category to keep separate from tools because helper systems often affect daily routine, automation, and farm layout. The exact mechanics are not yet independently confirmed here.',
  ...
  },
  {
    ...
    summary: 'Mineable items usually become high-intent wiki pages because players need exact floors, locations, and drop rates. Confirmed so far: Copper Ore is found in the Cave of Echoes, unlocked via "A Bridge Too Far." Other ore tiers are not yet independently confirmed here.',
  ...
  },
  {
    ...
    summary: 'Decoration pages are useful for players searching for furniture lists, shop rotations, seasonal decor, and room inspiration. Specific item names, sources, and prices are not yet independently confirmed here.',
