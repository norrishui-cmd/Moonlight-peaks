...
export const itemCategories: ItemCategory[] = [
  ...
  },
  {
    ...
    summary: 'Confirmed via Bonus Action: you have a cooking station in your starter home from the very beginning, along with 16 basic recipes already known, so you can start cooking as soon as you have ingredients. To cook, interact with the station, pick a recipe you have ingredients for (shown in full color), choose a quality tier, then complete a timing mini-game \u2014 pressing at the right moment, with higher quality tiers demanding more precise hits. More recipes are found by exploring and buying recipe books, and \u2014 per a Switch 2 review \u2014 some cooking and decorating recipes turn up simply by digging glowing swirl spots on the ground. Reported good early picks for restoring energy: Violet Sashimi and Gazpacho Stew/Soup. Community-reported: many of the earliest available dishes only restore 2-3 stamina, which can feel thin \u2014 dishes built around Blood Grapes or Blood Tomatoes are reported to restore noticeably more, and fish plus magical crops are also called out as strong vampire-cooking ingredients.',
