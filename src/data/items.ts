...
export const itemCategories: ItemCategory[] = [
  ...
  },
  {
    ...
    group: 'Crafting',
    status: 'confirmed',
    dek: 'A cooking station from day one, 40+ confirmed recipes across Food, Soup & Stew, and Sushi, sourced directly from the official wiki.',
    summary: 'Confirmed via the official Moonlight Peaks wiki: over 40 recipes are documented across three categories — Food (burgers, burritos, bread, pizza, cheese), Soup & Stew, and Sushi. Each recipe lists its cooking method (most run through the Cooking Station, some also need the Cheese Press, Enchanted Mortar, Herb Drying Rack, or a Mill), its ingredients, and its sell price across base/1-star/2-star quality tiers where confirmed. Not every recipe has its method, ingredients, or price filled in yet on the official wiki itself — those fields are marked as unconfirmed here rather than guessed. See the full recipe database below.',
    examples: ['Bread, burgers, burritos, pizza, and cheese dishes', '19+ soup and stew recipes', '11+ sushi/maki recipes', 'Recipes requiring Cheese Press, Enchanted Mortar, Herb Drying Rack, or Mill'],
    verify: ['Cooking method, ingredients, and prices still missing for several recipes on the official wiki', 'Where each additional recipe book or unlock is obtained', 'Full effects/energy restoration per dish'],
...
export const itemFrameworks: Record<string, ItemFramework> = {
  ...
  cooking: {
    parameters: [
      { label: 'Data status', value: 'Confirmed via the official wiki, 40+ recipes documented' },
      { label: 'Key fields', value: 'Cooking method, ingredients, sell price by quality (base / 1-star / 2-star)' },
      { label: 'Categories', value: 'Food, Soup & Stew, Sushi' },
    ],
    columns: ['Recipe', 'Category', 'Method', 'Ingredients', 'Sell Price (base / \u2605 / \u2605\u2605)'],
    rows: [
      ['Bread', 'Food', 'Cooking Station', '1 Flour', '150 / - / 220'],
      ['Breakfast Burger', 'Food', 'Cooking Station', '1 Fried Egg, 1 Bread, 2 Blood Tomato', '440 / 550 / -'],
      ['Hamburger', 'Food', 'Cooking Station', '1 Gobbler, 1 Bread, 1 Cheese', 'Not yet confirmed'],
      ['Veggie Burger', 'Food', 'Cooking Station', '1 Blood Tomato, 1 Common Mushroom, 1 Bread', '- / - / 520'],
      ['Fishy Burger', 'Food', 'Cooking Station', 'Not yet confirmed', 'Not yet confirmed'],
      ['Angry Burrito', 'Food', 'Cooking Station', 'Not yet confirmed', '900 / - / -'],
      ['Breakfast Burrito', 'Food', 'Cooking Station + Cheese Press', '1 Tortilla, 1 Fried Egg, 1 Hellfeta', 'Not yet confirmed'],
      ['Cheese Burrito', 'Food', 'Cooking Station + Cheese Press', '1 Rice, 1 Tortilla, 1 Ghoulembert', '900 / - / -'],
      ['Fishy Burrito', 'Food', 'Not yet confirmed', 'Not yet confirmed', 'Not yet confirmed'],
      ['Veggie Burrito', 'Food', 'Cooking Station', '2 Blood Tomato, 1 Rice, 1 Tortilla', '820 / 1,000 / -'],
      ['Rice', 'Food', 'Mill', '3 Unmilled Rice', '220'],
      ['Roti Roll', 'Food', 'Cooking Station', 'Not yet confirmed', 'Not yet confirmed'],
      ['Broodje Kaas', 'Food', 'Cooking Station', '1 Bread, 1 Cheese', '440'],
      ['Shakshuka', 'Food', 'Cooking Station / Enchanted Mortar / Herb Drying Rack', '1 Blood Tomato, 1 Egg, 1 Googly Garlic Powder', '850 / 1,100 / -'],
      ['Tortilla', 'Food', 'Cooking Station', '2 Red Corn', '160 / 200 / 240'],
      ['Cheese', 'Food', 'Cheese Press', '1 Cowcula Milk', '70 / 90 / 100'],
      ['Cheese Platter', 'Food', 'Not yet confirmed', 'Not yet confirmed', 'Not yet confirmed'],
      ['Ghoulembert', 'Food', 'Cheese Press', '1 Draculamb Milk', '- / - / 100'],
      ['Hellfeta', 'Food', 'Cheese Press', '1 Piggoat Milk', '70 / 90 / -'],
      ['Fried Egg', 'Food', 'Cooking Station', '1 Egg', '40 / 50 / -'],
      ['Angry Pizza', 'Food', 'Not yet confirmed', 'Not yet confirmed', '880 / 1,100 / -'],
      ['Margherita Pizza', 'Food', 'Cooking Station', '1 Blood Tomato, 1 Flour, 1 Cheese', '- / 400 / -'],
      ["Puk's Pizza", 'Food', 'Cooking Station', '1 Blood Tomato, 1 Onion, 1 Flour, 1 Cheese', '400 / - / -'],
      ['Ollebrod', 'Food', 'Cooking Station', '1 Bread, 1 Beer', 'Not yet confirmed'],
      ['Violet Sashimi', 'Food', 'Cooking Station', '1 Violet', '130'],
      ['Dried Seaweed', 'Food', 'Not yet confirmed', 'Not yet confirmed', 'Not yet confirmed'],
      ['Angry Soup', 'Soup & Stew', 'Cooking Station', 'Not yet confirmed', '1,400 / 1,800 / 2,100'],
      ['Carrot Soup', 'Soup & Stew', 'Not yet confirmed', 'Not yet confirmed', 'Not yet confirmed'],
      ['Cheese Soup', 'Soup & Stew', 'Cooking Station + Cheese Press', '1 Blood Tomato, 1 Ghoulembert', 'Not yet confirmed'],
      ['Chilly Soup', 'Soup & Stew', 'Not yet confirmed', 'Not yet confirmed', 'Not yet confirmed'],
      ['Eggplant Soup', 'Soup & Stew', 'Not yet confirmed', 'Not yet confirmed', 'Not yet confirmed'],
      ['Fishy Soup', 'Soup & Stew', 'Cooking Station', '1 Glibby, 1 Orbis', '280'],
      ['Gazpacho Soup', 'Soup & Stew', 'Cooking Station', '2 Blood Tomato, 1 Onion', '140 / 180 / -'],
      ['Googly Soup', 'Soup & Stew', 'Not yet confirmed', 'Not yet confirmed', 'Not yet confirmed'],
      ['Mushroom Soup', 'Soup & Stew', 'Cooking Station', '2 Common Mushroom, 2 Yellow Glowglammer', '120'],
      ['Potato Soup', 'Soup & Stew', 'Cooking Station', '1 Wild Potato, 1 Carrot, 1 Googly Garlic Powder', 'Not yet confirmed'],
      ["Puk's Soup", 'Soup & Stew', 'Cooking Station / Enchanted Mortar / Herb Drying Rack', '1 Onion, 1 Googly Garlic Powder', '860 / 1,100 / 1,300'],
      ["Farmer's Stew", 'Soup & Stew', 'Cooking Station', '2 Blood Tomato, 1 Eggplant', '240'],
      ['Mana Stew', 'Soup & Stew', 'Not yet confirmed', 'Not yet confirmed', '1,500'],
      ['Mana Mandrake Soup', 'Soup & Stew', 'Cooking Station', '1 Happy Mandrake, 1 Nightshade Powder, 1 Mana Essence', '2,400 / 3,000 / 3,600'],
      ['Mushroom Stew', 'Soup & Stew', 'Cooking Station', '1 Glowglammer, 1 Volacio Mushroom, 1 Yellow Glowglammer', '110'],
      ['Mystery Meat Stew', 'Soup & Stew', 'Not yet confirmed', 'Not yet confirmed', 'Not yet confirmed'],
      ['Pumpkin Stew', 'Soup & Stew', 'Cooking Station', '1 Yellow Glowglammer, 1 Pumpkin', 'Not yet confirmed'],
      ['Sunburst Stew', 'Soup & Stew', 'Not yet confirmed', 'Not yet confirmed', 'Not yet confirmed'],
      ['Watergruwel', 'Soup & Stew', 'Not yet confirmed', 'Not yet confirmed', 'Not yet confirmed'],
      ['Angry Maki', 'Sushi', 'Not yet confirmed', 'Not yet confirmed', 'Not yet confirmed'],
      ['Cruelcumber Maki', 'Sushi', 'Cooking Station', '2 Cruelcumber, 1 Rice, 1 Dried Seaweed', 'Not yet confirmed'],
      ['Gloy Gloy Maki', 'Sushi', 'Cooking Station', '1 Gloy Gloy, 1 Rice, 1 Dried Seaweed', 'Not yet confirmed'],
      ['Gnasher Maki', 'Sushi', 'Cooking Station', '1 Gnasher, 1 Rice, 1 Dried Seaweed', 'Not yet confirmed'],
      ['Huggy Maki', 'Sushi', 'Not yet confirmed', 'Not yet confirmed', 'Not yet confirmed'],
      ['Mouthout Maki', 'Sushi', 'Not yet confirmed', 'Not yet confirmed', 'Not yet confirmed'],
      ['Smelly Maki', 'Sushi', 'Cooking Station', '2 Skunktail, 1 Rice, 1 Dried Seaweed', 'Not yet confirmed'],
      ['Twilight Mana Maki', 'Sushi', 'Not yet confirmed', 'Not yet confirmed', 'Not yet confirmed'],
      ['Void Maki', 'Sushi', 'Not yet confirmed', 'Not yet confirmed', 'Not yet confirmed'],
      ['Orbis Nigiri', 'Sushi', 'Cooking Station', '1 Orbis, 1 Rice', 'Not yet confirmed'],
      ['Onigiri', 'Sushi', 'Cooking Station', '1 Whisper, 1 Rice, 1 Dried Seaweed', '550'],
    ],
    sourceNote: 'Sourced directly from the official Moonlight Peaks wiki\u2019s recipe tables (Food, Soup & Stew, and Sushi categories). Recipes with missing cooking method, ingredients, or price mean the wiki itself hasn\u2019t filled that field in yet \u2014 marked "Not yet confirmed" rather than invented.',
  },
  fish: {
    parameters: [
