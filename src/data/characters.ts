...
// IMAGE: square images live in public/characters/<id>.webp. Leave img:'' to show the generated SVG avatar.
...
export const characters: Character[] = [
  {
    ...
    status: 'confirmed', romanceable: false, img: '/characters/count-dracula.webp', c1: '#7a2f3f', c2: '#c0436a',
  ...
  },
  {
    ...
    status: 'confirmed', romanceable: true, img: '/characters/saga.webp', c1: '#5a4a2a', c2: '#caa24a',
  ...
  },
  {
    ...
    status: 'confirmed', romanceable: null, img: '/characters/mina.webp', c1: '#3a4a6a', c2: '#7aa2d0',
  ...
  },
  {
    ...
    status: 'reported', romanceable: true, img: '/characters/luna.webp', c1: '#4a2f6a', c2: '#a06ad0',
  ...
  },
  {
    ...
    status: 'reported', romanceable: true, img: '/characters/logan.webp', c1: '#4a3a2a', c2: '#b08a4a',
  ...
  },
  {
    ...
    status: 'reported', romanceable: false, img: '/characters/pumpkin-head.webp', c1: '#6a3f1a', c2: '#e08a3a',
  ...
  },
  {
    ...
    status: 'reported', romanceable: null, img: '/characters/the-warlock.webp', c1: '#3a2f6a', c2: '#9a7ad0',
