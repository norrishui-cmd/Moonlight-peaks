...
export const characters: Character[] = [
  ...
  { id: 'chester', name: 'Chester', family: 'Unknown', type: 'other', status: 'confirmed', romanceable: false, img: '', c1: '#4a3a2a', c2: '#a08a5a',
  ...
  { id: 'yabbis', name: 'Yabbis', family: 'Unknown', type: 'other', status: 'reported', romanceable: false, img: '', c1: '#3a4a3a', c2: '#7ab08a',
  ...
  { id: 'grim', name: 'Grim', family: 'Unknown', type: 'other', status: 'datamined', romanceable: false, img: '', c1: '#3a3a4a', c2: '#8a8ab0',
    desc: 'Name confirmed to exist via official wiki navigation, shown with the Hellkitten icon — possibly the Hellkitten companion\u2019s given name rather than a separate character. Not confirmed either way.',
    traits: [], knownInfo: ['Listed on the official wiki with the Hellkitten chibi icon; relationship to the shapeshifting Hellkitten form is not yet confirmed here.'] },
  { id: 'mr-deyes', name: 'Mr. Deyes', family: 'Unknown', type: 'other', status: 'datamined', romanceable: null, img: '', c1: '#3a3a3a', c2: '#8a8a9a',
  ...
  { id: 'hoodini', name: 'Hoodini', family: 'Unknown', type: 'other', status: 'datamined', romanceable: null, img: '', c1: '#3a4a4a', c2: '#6ab0b0',
  ...
  { id: 'rachel', name: 'Rachel', family: 'Unknown', type: 'other', status: 'datamined', romanceable: false, img: '', c1: '#3a3a3a', c2: '#8a8a8a',
    desc: 'Name confirmed to exist via official wiki navigation, shown with the Vampster icon — likely an individually-named Vampster rather than a townsperson. Not a romance option.',
    traits: [], knownInfo: ['Listed on the official wiki with the Vampster icon.'] },
  { id: 'snek', name: 'Snek', family: 'Unknown', type: 'other', status: 'datamined', romanceable: false, img: '', c1: '#2f4a3a', c2: '#5aa070',
  ...
  { id: 'jacques', name: 'Jacques', family: 'Unknown', type: 'other', status: 'datamined', romanceable: false, img: '', c1: '#2f4a3a', c2: '#5aa070',
    desc: 'A named snake character confirmed to exist via official wiki navigation, alongside Snek. Not a romance option.',
    traits: [], knownInfo: ['Listed on the official wiki with a snake chibi icon.'] },
  { id: 'moon-goddess', name: 'Moon Goddess', family: 'Unknown', type: 'other', status: 'datamined', romanceable: null, img: '', c1: '#4a4a6a', c2: '#9a9ad0',
    desc: 'A deity-type figure confirmed to exist via official wiki navigation; role not yet sourced.',
    traits: [], knownInfo: ['Listed on the official wiki; likely tied to the game\u2019s night/moon mythology.'] },
  { id: 'sun-god', name: 'Sun God', family: 'Unknown', type: 'other', status: 'datamined', romanceable: null, img: '', c1: '#6a5a2a', c2: '#d0a84a',
    desc: 'A deity-type figure confirmed to exist via official wiki navigation; role not yet sourced.',
    traits: [], knownInfo: ['Listed on the official wiki; likely the Moon Goddess\u2019 counterpart in the game\u2019s mythology.'] },
  { id: 'yasmin', name: 'Yasmin', family: 'Unknown', type: 'other', status: 'datamined', romanceable: null, img: '', c1: '#4a3a4a', c2: '#a06aa0',
    desc: 'Name confirmed to exist via official wiki navigation; role not yet sourced.',
    traits: [], knownInfo: ['Listed on the official wiki; no further detail sourced yet.'] },
];
