...
export const characters: Character[] = [
  ...
  { id: 'llemi', name: 'Llemi', family: 'Unknown', type: 'other', status: 'confirmed', romanceable: true, img: '/llemi.webp', c1: '#2f4a4a', c2: '#6ab0b0',
    desc: 'Confirmed via the official wiki: a dateable, childish and whimsical love demon who feeds off drama and chaos \u2014 which is exactly why Moonlight Peaks draws him in. He calls the rosy pastures of the Pink Grove home and is described as guiding the hearts of the town.',
    traits: [['Chaos', 85], ['Charm', 70]], traitsPlaceholder: true,
    knownInfo: ['Confirmed via the official wiki as a dateable character, childish and whimsical by nature, who lives in the Pink Grove and feeds off drama and chaos.', 'Said to only be seen in town during festivals; winning his heart is described as taking real effort.'],
    // Gift data via Nintendo Everything's character showcase coverage (launch week).
  ...
  { id: 'skull-girl', name: 'Skull Girl', family: 'Unknown', type: 'other', status: 'confirmed', romanceable: null, img: '/skull-girl.webp', c1: '#3a3a4a', c2: '#8a8ab0',
    desc: 'Confirmed to be a fully-developed NPC with her own schedule, gifts, and relationship events \u2014 grouped with Llemi, Pumpkin Head, and other family-less characters on the official wiki. Her personality and backstory aren\u2019t sourced yet, but she\u2019s far more than a name-only listing.',
    traits: [], knownInfo: [
      'Confirmed via the official wiki\u2019s character navigation: grouped alongside Llemi, Pumpkin Head, Albertus, Chester, Grim, Hoodini, Larry, Mr. Deyes, Rachel, and Yabbis as a character belonging to no family.',
      'Confirmed via a dedicated third-party character database (birthday, gift-reaction lists, relationship events, and a daily schedule all documented): she\u2019s a real, systemically-tracked resident, not a background cameo.',
      'Not yet sourced: her personality, backstory, or exact role in the story \u2014 we\u2019ll update this the moment a reliable source describes her rather than guessing from the name.',
      'Whether she can be romanced is currently unverified \u2014 unlike Llemi, who the official wiki explicitly tags "dateable," no such tag has turned up for Skull Girl yet.',
    ] },
  ...
  { id: 'grim', name: 'Grim', family: 'Unknown', type: 'other', status: 'reported', romanceable: false, img: '/grim.webp', c1: '#3a3a4a', c2: '#8a8ab0',
  ...
  { id: 'larry', name: 'Larry', family: 'Unknown', type: 'other', status: 'confirmed', romanceable: false, img: '/larry.webp', c1: '#3a3a3a', c2: '#8a8a8a',
    desc: 'Confirmed via the official wiki: Larry is a Vampster living in Alina\u2019s home who doesn\u2019t want to be returned to the Cave of Echoes, so he stays with her instead of joining the other collectible Vampsters. Not a romance option.',
    traits: [], knownInfo: ['Confirmed: found in Alina\u2019s home, choosing to stay rather than be returned like the other Vampsters.'] },
  { id: 'rachel', name: 'Rachel', family: 'Unknown', type: 'other', status: 'datamined', romanceable: false, img: '/rachel.webp', c1: '#3a3a3a', c2: '#8a8a8a',
  ...
  { id: 'jacques', name: 'Jacques', family: 'Unknown', type: 'other', status: 'datamined', romanceable: false, img: '/jacques.webp', c1: '#2f4a3a', c2: '#5aa070',
    ...
    traits: [], knownInfo: ['Listed on the official wiki with a snake chibi icon.'] },
  { id: 'moon-goddess', name: 'Moon Goddess', family: 'Unknown', type: 'other', status: 'confirmed', romanceable: false, img: '/moon-goddess.webp', c1: '#4a4a6a', c2: '#9a9ad0',
    desc: 'Confirmed via the official wiki: a deity who descends from her palace of moonrock during the full moon to bless Moonlight Peaks with her presence \u2014 esoteric in speech, but genuinely enjoys walking among mortals.',
    traits: [], knownInfo: [
      'Confirmed via the official wiki: appears specifically when the moon is full, and is described as loving to walk among ordinary townspeople despite her otherwise cosmic, esoteric manner of speech.',
      'Confirmed to be the Sun God\u2019s sibling (cosmic twin).',
      'Community-reported (Japanese-language coverage): grouped with Brook as a friendship-only NPC, not a romance option \u2014 consistent with her status here.',
    ] },
  { id: 'sun-god', name: 'Sun God', family: 'Unknown', type: 'other', status: 'confirmed', romanceable: false, img: '/sun-god.webp', c1: '#6a5a2a', c2: '#d0a84a',
    desc: 'Confirmed via the official wiki: the Moon Goddess\u2019s cosmic-twin brother, a rare sight who only shows himself at the zenith of Summer \u2014 haughty and self-important, with few friends in town and an aura that keeps "night-dwellers" at a distance.',
    traits: [], knownInfo: [
      'Confirmed via the official wiki: only appears at Summer\u2019s zenith, described as radiating a haughty, self-important demeanor that pushes nocturnal residents away.',
      'Confirmed to have few friends in town, a fact the character himself is described as sharply aware of.',
      'Community-reported (Japanese-language coverage): grouped with Brook as a friendship-only NPC, not a romance option \u2014 consistent with his status here.',
    ] },
