...
export const previews: Preview[] = [
  ...
  // ───────────────────────── GUIDES (confirmed-fact deep dives) ─────────────────────────
  {
    ...
    dek: 'Dating, marriage and the one big \u201Cno\u201D \u2014 what is confirmed about relationships now that the game is out, kept separate from what we are not guessing at.',
    date: 'June 2026', readTime: '5 min', tag: 'Romance', image: '/art-moonlit-date.webp',
    body: [
      { type: 'p', text: 'Romance is a core part of the cozy loop in Moonlight Peaks, and one of the most-searched topics since launch. Here is what the developers, press previews, and the live game have actually confirmed \u2014 kept separate from anything we are still not guessing at.' },
      { type: 'link', text: 'For the full step-by-step romance and marriage guide, including all 23 confirmed romance options, see the', href: '/romance', linkLabel: 'main romance page' },
      { type: 'h2', text: 'You can marry \u2014 but you cannot have children' },
      { type: 'p', text: 'Marriage is confirmed: you can date residents and eventually marry, at Heart Level 8, with the wedding taking place within a week. Children, however, are confirmed to be out \u2014 there is no child-raising system, which sets it apart from sims like Stardew Valley, Coral Island and Sun Haven.' },
      { type: 'h2', text: '23 confirmed romance options, with no gender lock' },
      { type: 'p', text: 'The romanceable roster is confirmed at 23 residents across six families (plus two who belong to no family), and dating is gender-neutral \u2014 you are not restricted by your character\u2019s gender. Heart Level 4 unlocks dating; you can date more than one person casually before committing, though marriage itself is strictly monogamous.' },
      { type: 'image', src: '/art-secluded-embrace.webp', caption: 'Illustrative art \u00b7 Moonlight Peaks Wiki' },
      { type: 'h2', text: 'Saga is the best-documented confirmed option' },
      { type: 'p', text: 'Saga, a werewolf whose energy shifts with the full moon, is the resident with the most confirmed detail so far, including gift preferences (she loves white wine, likes single flowers, dislikes bouquets). The other 22 confirmed options have less individually-documented detail as we verify more.' },
      { type: 'h2', text: 'What we are still not guessing' },
      { type: 'ul', items: [
        'Per-character gift preferences for most of the roster \\u2014 only Saga\'s are fully confirmed so far; we will not invent gift tables for the rest.',
        'The complete card/collectible tie-ins some residents may have (e.g. Nokturna matches logged in a friendship menu).',
        'Exact schedules for most named residents.',
      ] },
      { type: 'callout', text: 'We label confirmed vs reported throughout, and add gift and schedule data only once it\u2019s verified against the live game.' },
    ],
    sources: [
      { label: 'PC Gamer — hands-on preview', url: 'https://www.pcgamer.com/games/life-sim/moonlight-peaks-preview-impressions/' },
      { label: 'Official site', url: 'https://www.moonlightpeaks.com/' },
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'p', text: 'A "love demon" also raises an obvious question for anyone planning their romance route: is this a new romanceable character, a chaos-causing side character, or both? Confirmed: this matches Llemi, a whimsical love demon who feeds on drama and chaos, lives in the Pink Grove, and is a confirmed romance option — one of only two romanceable residents who belong to no family (the other is Death).' },
      { type: 'link', text: 'For what the romance angle specifically means for your relationship options, see', href: '/previews/romance-drama-dinner-party-and-love-demon', linkLabel: 'our companion piece on the love demon and romance' },
      { type: 'callout', text: 'These are early, specific details from one preview account, now cross-checked against confirmed character data — see Llemi\'s profile for what\u2019s verified.' },
    ],
    sources: [{ label: 'PC Gamer — hands-on preview', url: 'https://www.pcgamer.com/games/life-sim/moonlight-peaks-preview-impressions/' }],
  },
  {
  ...
  // ───────────────────────── NEW BATCH: romance expansion (July 2026) ─────────────────────────
  {
    slug: 'romance-roster-from-15-to-24', category: 'guide',
    title: 'From 15 to 24: How the Romance Roster Grew',
    dek: 'The dateable cast got noticeably bigger during development — here\u2019s the timeline, as best we can trace it.',
    date: 'July 2026', readTime: '3 min', tag: 'Romance', image: '/hero-families-and-residents.webp',
    body: [
      { type: 'p', text: 'One detail that tends to surprise returning followers of the game: the number of romanceable residents isn\u2019t fixed, and it grew during development.' },
      { type: 'h2', text: 'What changed' },
      { type: 'p', text: 'Earlier coverage of Moonlight Peaks cited roughly 15 romance options. The current official Steam page describes around two dozen — closer to 24. That\u2019s a real, meaningful increase, not a rounding difference.' },
      { type: 'h2', text: 'Why it matters for launch' },
      { type: 'p', text: 'A growing roster this close to release is generally a good sign — it suggests the relationship system was a priority worth expanding rather than trimming. It also means older previews, videos, or articles that say "15 romanceable characters" are now out of date.' },
      { type: 'p', text: 'The developers have also indicated they hope to keep adding to the cast after launch, so even 24 may not be the final number long-term.' },
      { type: 'callout', text: 'Our characters page tracks every named resident and their confirmation status as the real number becomes clear at launch.' },
    ],
    sources: [{ label: 'Official Steam page', url: 'https://store.steampowered.com/app/2209900/Moonlight_Peaks/' }],
  },
  {
    slug: 'can-you-romance-death', category: 'preview',
    title: 'Can You Romance Death in Moonlight Peaks?',
    dek: 'A grim reaper on a dating roster sounds like a joke — except the name keeps showing up in real sources.',
    date: 'July 2026', readTime: '3 min', tag: 'Romance', image: '/hero-loc-graveyard.webp',
    body: [
      { type: 'p', text: 'Of all the pre-launch romance speculation floating around Moonlight Peaks, "can you date Death" is the one that keeps resurfacing — and unlike most rumors, this one has some real footing.' },
      { type: 'h2', text: 'What\u2019s actually confirmed' },
      { type: 'p', text: 'Pre-launch datamined game files list "Death" as a named resident, alongside a home called "Death\u2019s Shack" — meaning he\u2019s very likely a real, developed character rather than a placeholder or a joke NPC.' },
      { type: 'h2', text: 'What\u2019s speculation' },
      { type: 'p', text: 'Whether Death is actually romanceable has not been confirmed by the developers anywhere we\u2019ve found. Some pre-launch community chatter has floated the idea, likely because it fits the game\u2019s cozy-gothic sense of humor so well — but "fits the vibe" isn\u2019t the same as "confirmed."' },
      { type: 'h2', text: 'Why we\u2019re not just saying yes' },
      { type: 'p', text: 'It would be easy to round "has a house and a fun theme" up to "definitely romanceable," but that\u2019s exactly the kind of gap where fan wikis start inventing things. We\u2019d rather tell you honestly that this is unconfirmed than give you false confidence going into launch.' },
      { type: 'callout', text: 'We\u2019ll update this the moment the full game settles it one way or the other on July 7, 2026.' },
    ],
    sources: [{ label: 'Moonlight Peaks Wiki (wiki.gg) — datamine', url: 'https://moonlightpeaks.wiki.gg/' }],
  },
  {
    slug: 'dating-across-the-family-divide', category: 'guide',
    title: 'Dating Across the Vampire-Werewolf Divide',
    dek: 'Vampires and werewolves famously don\u2019t get along in Moonlight Peaks. Here\u2019s what that means if you romance across the line.',
    date: 'July 2026', readTime: '3 min', tag: 'Romance', image: '/art-secluded-embrace.webp',
    body: [
      { type: 'p', text: 'Saga, a confirmed werewolf romance option, is an easy pick if you like the idea of dating outside your own vampire family — but it\u2019s worth knowing what you\u2019re walking into first.' },
      { type: 'h2', text: 'The confirmed tension' },
      { type: 'p', text: 'Reporting on the game describes vampires and werewolves as rarely getting along, trading the kind of petty spats you\u2019d expect from families with centuries of history between them. A press hands-on preview separately describes an old feud running between the town\u2019s seven supernatural families more broadly.' },
      { type: 'h2', text: 'Does it affect romance mechanically?' },
      { type: 'p', text: 'Unconfirmed. Nothing we\u2019ve seen says family tension blocks or complicates a romance route in an actual mechanical sense — this reads more like flavor and tone than a real gameplay obstacle. But it also hasn\u2019t been ruled out.' },
      { type: 'h2', text: 'The appeal, honestly' },
      { type: 'p', text: 'If the game leans into its "chibi-cute but seriously toxic" social drama the way early coverage suggests, dating across family lines is probably meant to feel like a small act of rebellion — which fits a cozy-gothic game a lot better than a mechanical penalty would.' },
      { type: 'callout', text: 'Nothing here is a confirmed mechanic — just the honest read on what\u2019s been reported so far.' },
    ],
    sources: [{ label: 'PC Gamer — hands-on preview', url: 'https://www.pcgamer.com/games/life-sim/moonlight-peaks-preview-impressions/' }],
  },
  {
    slug: 'romance-drama-dinner-party-and-love-demon', category: 'preview',
    title: 'What the Love Demon Means for Romance',
    dek: 'A press preview name-drops a "rogue love demon" causing chaos at a dinner party. Here\u2019s the romance angle specifically.',
    date: 'July 2026', readTime: '2 min', tag: 'Romance', image: '/hero-doomed-dinner-party-and-the-love-demon.webp',
    body: [
      { type: 'link', text: 'We\u2019ve already covered the doomed dinner party as a story beat — see', href: '/previews/doomed-dinner-party-and-the-love-demon', linkLabel: 'that companion piece' },
      { type: 'h2', text: 'Resolved: the love demon is a confirmed romance option' },
      { type: 'p', text: 'Update: this is confirmed. The "rogue love demon" is Llemi, a whimsical love demon who feeds on drama and chaos, lives in the Pink Grove, and is one of the 23 confirmed romance options — one of only two romanceable residents (alongside Death) who belong to no family.' },
      { type: 'h2', text: 'Our original guess, for the record' },
      { type: 'p', text: 'Our initial read, before this was confirmed, was that a chaos-causing love demon seemed more likely to be a plot device stirring up drama between other characters than a straightforward romance option. That guess turned out to be wrong — keeping it here rather than quietly deleting it, since it\u2019s a useful example of how far a hands-on preview alone can (and can\u2019t) get you.' },
      { type: 'link', text: 'See what\u2019s confirmed about Llemi on the', href: '/characters/llemi', linkLabel: 'full character profile' },
    ],
    sources: [{ label: 'PC Gamer — hands-on preview', url: 'https://www.pcgamer.com/games/life-sim/moonlight-peaks-preview-impressions/' }],
  },
  {
    slug: 'best-romance-picks-by-vibe', category: 'guide',
    title: 'Best Moonlight Peaks Romance Picks by Vibe',
    dek: 'Not an official tier list — just an honest read on who fits which mood, based on what\u2019s actually been said about each of them.',
    date: 'July 2026', readTime: '3 min', tag: 'Romance', image: '/art-midnight-brewery.webp',
    body: [
      { type: 'p', text: 'With around two dozen romance options and almost no confirmed gift or compatibility data yet, "who should I romance" doesn\u2019t have a data-driven answer at launch minus one week. What we can do honestly is match vibes to what\u2019s actually been said about each character.' },
      { type: 'h2', text: 'Want confident and dramatic?' },
      { type: 'p', text: 'The Warlock — seen in a hands-on preview as a self-obsessed flirt who won\u2019t stop interrupting to hit on the player. His real name is still unconfirmed, but the energy isn\u2019t subtle.' },
      { type: 'h2', text: 'Want steady and useful?' },
      { type: 'p', text: 'Luna — reported as a farming witch, likely your earliest source for spells and gardening know-how. The practical, grounded pick.' },
      { type: 'h2', text: 'Want old-world authority?' },
      { type: 'p', text: 'Orlock — reported as the head of a vampire family, described as a figure of old-world influence in town.' },
      { type: 'h2', text: 'Want mysterious and a little dangerous?' },
      { type: 'p', text: 'Death — unconfirmed as romanceable, but if the speculation is right, nobody else on this list comes close on atmosphere alone.' },
      { type: 'h2', text: 'Want a clean slate?' },
      { type: 'p', text: 'Mina — named by the developers, but almost nothing else about her is public. Sometimes not knowing is the appeal.' },
      { type: 'callout', text: 'Try our Romance Match Quiz for a more playful version of this same idea, or see the Romance Gift Finder for verification status on every named character.' },
    ],
    sources: [{ label: 'PC Gamer — hands-on preview', url: 'https://www.pcgamer.com/games/life-sim/moonlight-peaks-preview-impressions/' }],
  },
