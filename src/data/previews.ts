...
export const previews: Preview[] = [
  ...
  },
  {
    ...
    body: [
      { type: 'p', text: 'We\u2019ve already covered the doomed dinner party as a story beat — but if you\u2019re specifically planning your romance route, the "rogue love demon" detail from that same preview deserves its own look.' },
      { type: 'h2', text: 'The open question' },
      { type: 'p', text: 'A love demon causing chaos raises an obvious possibility: some kind of temporary attraction, jealousy, or love-triangle event tied to that character, rather than a straightforward new dating option. Neither has been confirmed — the preview mentions the demon\u2019s existence without describing what they actually do.' },
      { type: 'h2', text: 'Our honest read' },
      { type: 'p', text: 'Given the game\u2019s "seriously toxic but in a good way" social tone, a chaos-causing love demon fits better as a plot device that stirs up drama between other characters than as a straightforward romance option for the player. That\u2019s a guess, not a fact — we\u2019re flagging our reasoning so you can weigh it yourself.' },
      { type: 'callout', text: 'If the love demon turns out to be a named, romanceable character, we\u2019ll build them a full profile the moment the game confirms it.' },
    ],
    sources: [{ label: 'PC Gamer — hands-on preview', url: 'https://www.pcgamer.com/games/life-sim/moonlight-peaks-preview-impressions/' }],
  },
  {
