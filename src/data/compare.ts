...
export const comparisons: Comparison[] = [
  ...
  {
    slug: 'palia', other: 'Palia',
    dek: 'A free-to-play multiplayer community sim versus a solo, story-driven gothic vampire farm.',
    otherStatus: 'Palia (Singularity 6) is out now — free-to-play, cross-platform, and continually updated with seasonal content since its 2023 launch.',
    rows: [
      row('Status', 'Out now, free-to-play, actively updated with seasonal content', MP.status),
      row('Setting', 'The fantasy world of Kilima Valley, home to the mystical Majiri', MP.setting),
      row('You play as', 'A human, part of a legendary race that mysteriously vanished long ago', MP.play),
      row('Farming', 'Farming, fishing, foraging and cooking woven into a shared, persistent world', MP.farming),
      row('Magic', 'Light fantasy elements tied to Majiri lore rather than a wand/spell system', MP.magic),
      row('Romance & marriage', 'Dateable Villagers; no marriage system confirmed', MP.romance),
      row('Combat', 'Minimal, optional PvE — no PvP', MP.combat),
      row('Multiplayer', 'Free-to-play online multiplayer MMO, cross-play and cross-progression', MP.mp_multi),
      row('Platforms', 'PC, Nintendo Switch, PS5, Xbox Series X/S (free)', MP.platforms),
    ],
    verdict: [
      'Pick Palia if you want a free, ongoing multiplayer community sim you can play with friends across consoles and PC, with no upfront cost.',
      'Pick Moonlight Peaks if you want a paid, finite, story-driven single-player experience with a gothic vampire twist, wand magic, shapeshifting, and marriage — Palia has no marriage system and is built around its live, evolving multiplayer world rather than a personal story.',
    ],
    related: [{ label: 'Romance & families', href: '/romance' }, { label: 'Platforms & price', href: '/platforms' }, { label: 'All comparisons', href: '/compare' }],
    faq: [
      { q: 'Is Moonlight Peaks like Palia?', a: 'Both are cozy life sims, but Palia is a free-to-play multiplayer MMO with no marriage system, while Moonlight Peaks is a paid single-player game with a gothic vampire story, wand magic, and marriage.' },
      { q: 'Is Moonlight Peaks free like Palia?', a: 'No — Moonlight Peaks is a paid game with a free demo, unlike the fully free-to-play Palia.' },
    ],
  },
  {
    slug: 'go-go-town', other: 'Go-Go Town!',
    dek: 'A tourist-town management sim with co-op, versus a solo gothic vampire farm with romance.',
    otherStatus: 'Go-Go Town! (Prideful Sloth) leaves Early Access for its 1.0 launch on July 16, 2026 on PC and Nintendo Switch/Switch 2 — nine days after Moonlight Peaks.',
    rows: [
      row('Status', '1.0 launches July 16, 2026 (Early Access available now)', MP.status),
      row('Setting', 'A run-down tourist town you rebuild as its new mayor', MP.setting),
      row('You play as', 'The town\u2019s newly appointed mayor', MP.play),
      row('Farming', 'Light farming/fishing/mining folded into a broader town-management and automation loop', MP.farming),
      row('Magic', 'None — grounded town-builder rather than a magic system', MP.magic),
      row('Romance & marriage', 'No romance or marriage system — focus is town-building, not relationships', MP.romance),
      row('Combat', 'None — cozy management sim', MP.combat),
      row('Multiplayer', 'Online co-op up to 4 players (2 on Switch), plus local split-screen', MP.mp_multi),
      row('Platforms', 'PC (Steam), Nintendo Switch & Switch 2 at 1.0; PS5/PS4/Xbox planned later', MP.platforms),
    ],
    verdict: [
      'Pick Go-Go Town! if you want a town-management and automation sim you can build with up to three friends — it has no romance system, and its focus is logistics and tourism rather than personal relationships.',
      'Pick Moonlight Peaks if you want farming plus a full romance and marriage system, wand magic, and a single-player gothic story — Go-Go Town! doesn\u2019t have dateable characters at all.',
    ],
    related: [{ label: 'Release date', href: '/release-date' }, { label: 'Farming', href: '/farming' }, { label: 'All comparisons', href: '/compare' }],
    faq: [
      { q: 'Is Moonlight Peaks like Go-Go Town?', a: 'Not really beyond the cozy tone — Go-Go Town is a co-op town-management and automation sim with no romance system, while Moonlight Peaks is a single-player vampire farming sim built around romance, marriage, and magic.' },
      { q: 'Which releases first, Moonlight Peaks or Go-Go Town?', a: 'Moonlight Peaks launches July 7, 2026. Go-Go Town! reaches its 1.0 release nine days later, on July 16, 2026.' },
    ],
  },
  {
    slug: 'my-time-at-evershine', other: 'My Time at Evershine',
    dek: 'An upcoming co-op town-governor sim from the My Time series, versus a solo gothic vampire farm out now.',
    otherStatus: 'My Time at Evershine (Pathea Games) was still in early development as of its reveal, with no confirmed release date — unlike Moonlight Peaks, which has a firm July 7, 2026 launch.',
    rows: [
      row('Status', 'In early development, no confirmed release date', MP.status),
      row('Setting', 'A new Alliance settlement built up from a campfire site, two years after My Time at Sandrock', MP.setting),
      row('You play as', 'A governor directing an entire town\u2019s growth (a shift from being a builder in earlier My Time games)', MP.play),
      row('Farming', 'Life-sim resource gathering and survival-lite crafting folded into settlement management', MP.farming),
      row('Magic', 'None confirmed — grounded sci-fi/fantasy settlement builder', MP.magic),
      row('Romance & marriage', 'Planned 8\u201310 romanceable companions; marriage not detailed yet', MP.romance),
      row('Combat', 'Some combat expected — described as more \u201Cadventurous\u201D than prior My Time games', MP.combat),
      row('Multiplayer', 'Planned full-campaign co-op for up to 4 players', MP.mp_multi),
      row('Platforms', 'Not yet confirmed', MP.platforms),
    ],
    verdict: [
      'Pick My Time at Evershine, once it releases, if you want a co-op settlement-management game with some combat and a smaller romance roster of 8\u201310 companions.',
      'Pick Moonlight Peaks right now if you want a finished, single-player gothic vampire farm sim with roughly two dozen romance options, marriage, wand magic and shapeshifting — Evershine has no confirmed release date yet, while Moonlight Peaks is out July 7, 2026.',
    ],
    related: [{ label: 'Romance & families', href: '/romance' }, { label: 'Release date', href: '/release-date' }, { label: 'All comparisons', href: '/compare' }],
    faq: [
      { q: 'Is Moonlight Peaks like My Time at Evershine?', a: 'Both have romance and a life-sim base, but Evershine casts you as a town governor with some combat and co-op, while Moonlight Peaks is a single-player vampire farm with marriage, wand magic, and shapeshifting. Evershine also has no confirmed release date yet.' },
      { q: 'Which releases first, Moonlight Peaks or My Time at Evershine?', a: 'Moonlight Peaks has a firm release date of July 7, 2026. My Time at Evershine has no confirmed release date as of this writing.' },
    ],
  },
];
