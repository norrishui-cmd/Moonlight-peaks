...
const staticPages: Doc[] = [
  ...
  { t: 'Spellcasting', d: 'Spell icons, mana costs, descriptions, and buy prices from the spellcasting screenshots.', u: '/spellcasting', k: 'Guide' },
  ...
  { t: 'Launch day', d: 'What to check first on launch day: release timing, demo, settings, known issues, and beginner links.', u: '/launch-day', k: 'Guide' },
